...
-->
    <el-table v-loading="loading" :data="policyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="保单id" align="center" prop="id" />
...
<script>
import { doUnderwriting, listUnderwriting } from "@/api/underwriting/underwriting";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listUnderwriting().then(response => {
    ...
    handleUpdate(row) {
      ...
      doUnderwriting(id).then(response => {
